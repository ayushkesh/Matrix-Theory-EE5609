...
%\end{align}
Thus the direction vectors of the two lines satisfies the equation \ref{eq:1}, hence proved that the lines are \textbf{perpendicular}.
\\
\textbf{Python Code:}
%
\begin{lstlisting}
