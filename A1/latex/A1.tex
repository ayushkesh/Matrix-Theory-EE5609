...
\begin{align}
    ...
    \implies\vec{a}^T\brak{\vec{a}-\vec{b}}+\vec{b}^T\brak{\vec{a}-\vec{b}}\\
    \implies\vec{a}^T\vec{a}-\vec{a}^T\vec{b}+\vec{b}^T\vec{a}-\vec{b}^T\vec{b}
\end{align}
\begin{align}
    \because \vec{a}^T\vec{a}=1\\
    \implies-\vec{a}^T\vec{b}+\vec{b}^T\vec{a}
\end{align}
\begin{align}
\vec{A}\vec{B}= -\myvec{ 5 \\ -1 \\ -3 }^T\myvec{ 1 \\ 3 \\ -5}+\myvec{ 1 \\ 3 \\ -5}^T\myvec{ 5 \\ -1 \\ -3 }\\
\vec{A}\vec{B}= -\myvec{ 5 & -1 & -3 }\myvec{ 1 \\ 3 \\ -5}+\myvec{ 1 & 3 & -5}\myvec{ 5 \\ -1 \\ -3 }
\end{align}
\begin{align}
\vec{AB}= \brak{5\times1+(-1)\times3-(-3)\times(-5)} \\\ -\brak{1\times5+3\times(-1)+(-5)\times(-3)}\\
\implies(5-3+15)-(5-3+15)=0
\end{align}
\begin{align}
